...
{{-- <button
  ...
  type="button" data-modal-toggle="item-request-create">
  Toggle modal
</button> --}}
@php
...
<!-- Main modal -->
<div id="item-request-create" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative w-full h-full max-w-md md:h-auto">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      <button type="button"
        ...
        data-modal-toggle="item-request-create">
      ...
      <div class="px-6 py-6 lg:px-8">
        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">{{ __('Add New Item Request') }}</h3>
