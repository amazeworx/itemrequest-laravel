...
<x-app-layout>
              ...
              <tbody>
                ...
                <tr id="row-{{ $item->id }}">
                  ...
                  <td>
                    <div class="flex gap-x-2 justify-between">
                      ...
                      <div class="dropdown dropdown-fixed">
                        <label tabindex="0" class="link link-primary link-hover">Update</label>
                        <div tabindex="0" class="dropdown-content shadow bg-base-100 rounded-box w-52">
                          <ul class="p-2">
                            @foreach ($statuses as $status)
                            <li class="text-sm bg-white hover:bg-slate-100 p-2 rounded-lg">
                              <div class="flex gap-x-2 items-center">
                                <input id="radio-{{ $item->id }}-status-{{ $status->id }}" type="radio"
                                  name="radio-status-{{ $item->id }}" class="flex-none cursor-pointer"
                                  value="{{ $status->id }}" {{ ($item->status->id ==
                                $status->id) ?
                                "checked" : ""
                                }} />
                                <label for="radio-{{ $item->id }}-status-{{ $status->id }}"
                          ...
                          <div class="border-t p-2">
                            <button type="button" class="btn-update-status btn btn-primary btn-sm w-full"
                  ...
                  <td class="text-right space-x-3">
                    ...
                    <a href="#!" data-id="{{ $item->id }}"
                      class="delete_item_request link link-primary link-hover">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      /*
       * Load view Item Request
       */
      // let view_item_request_id = 1;
      // $("#view_item_id").val('1');
      // $.ajax({
      //   url: `api/item_request/${view_item_request_id}`,
      //   type: "GET",
      //   cache: false,
      //   success:function(response){
       ...
       * View Item Request
       */
      $('.view_item_request').click(function (e) {
        e.preventDefault();
      ...
      $('#view--btn-show-select-status').click(function (e) {
        e.preventDefault();
      ...
      $('#view--btn-cancel-update-status').click(function (e) {
        e.preventDefault();
       ...
       */
      $('.edit_item_request').click(function (e) {
        e.preventDefault();
        let item_request_id = $(this).data("id");
       ...
       */
      $('#btn-edit-item-request').click(function(e) {
        e.preventDefault();
