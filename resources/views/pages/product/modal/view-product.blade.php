        ...
        <div>
          <div id="view-product_name" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              ...
              <div id="view--data-product_name" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-product_sku" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div
                class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 whitespace-nowrap text-slate-500 uppercase">
                SKU</div>
              <div id="view--data-product_sku" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-product_brand" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              ...
              <div id="view--data-product_brand" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-product_year" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div
                class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 whitespace-nowrap text-slate-500 uppercase">
                Tahun</div>
              <div id="view--data-product_year" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-product_cc" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div
                class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 whitespace-nowrap text-slate-500 uppercase">
                CC</div>
              <div id="view--data-product_cc" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-product_engine" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              ...
              <div id="view--data-product_engine" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          ...
          <div id="view-price_buy" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              ...
              <div id="view--data-price_buy" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          @endcan
          ...
          <div id="view-price_resell" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 text-slate-500 uppercase">Harga
                Jual Toko</div>
              <div id="view--data-price_resell" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          @endcan
          ...
          <div id="view-price_retail" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 text-slate-500 uppercase">Harga
                Jual User</div>
              <div id="view--data-price_retail" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
          @endcan
          ...
          <div id="view-product_notes" style="display: none">
            <div class="flex gap-x-4 py-2 border-b">
              <div class="w-1/3 font-medium text-xs md:text-sm leading-5 md:leading-6 text-slate-500 uppercase">Catatan
              </div>
              <div id="view--data-product_notes" class="w-2/3 text-sm md:text-base"></div>
            </div>
          </div>
